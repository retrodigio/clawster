...
| 7 | **Model split** — builders on `sonnet` (implementation), critics on `opus` (conversation) | The critic's judgment is the quality ceiling of the whole loop, and it is the cheaper role: few calls, short outputs. |
